...
The latest release is **3.1.0**.

* [strophejs-3.1.0.tar.gz](https://github.com/strophe/strophejs/archive/v3.0.1.tar.gz)
* [strophejs-3.1.0.zip](https://github.com/strophe/strophejs/archive/v3.0.1.zip)
