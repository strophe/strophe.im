...
* [Latest documentation](doc/1.2.9)
...
The latest release is **1.2.9**.

* [strophejs-1.2.9.tar.gz](https://github.com/strophe/strophejs/archive/v1.2.9.tar.gz)
* [strophejs-1.2.9.zip](https://github.com/strophe/strophejs/archive/v1.2.9.zip)
...
[Strophe.js API Documentation](doc/1.2.9)
